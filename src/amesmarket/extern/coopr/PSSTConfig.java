...
//    private final String solutionWriter;
     ...
     * @return
     */
    public static PSSTConfig createDeterministicPSST(File pyomoSolPrint, File referenceModel, File referenceFile) {
        return new PSSTConfig("psst",
