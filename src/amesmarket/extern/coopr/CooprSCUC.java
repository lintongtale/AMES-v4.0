...
/**
 *
 * @author Sean Mooney, Dheepak Krishnamurthy, Auswin Thomas
 */

public class CooprSCUC implements SCUC {
     ...
     */
    private final CooprConfig cooprExt;

    public CooprSCUC(ISO independentSystemOperator, AMESMarket model) {
        ames = model;
        ...
        case SCUC_STOC :
          //Run the External SCUC.
            cooprExt = CooprConfig.createStochasticCoopr(referenceModelDir, scenarioModelDir, "runefsolprint");
            break;
        case SCUC_DETERM :
            cooprExt = CooprConfig.createDeterministicCoopr(pyomoSolPrint,
    ...
    public void syscall(CooprConfig runefConfig) throws IOException {
        Process p = runefConfig.createCooprProcess();
