...
public class PowerGridConfigure5 extends LSEDemandConfig {
    ...
    public void  loadData(Object [][] lseFixedData, Object[][][] lsePriceSensitiveData, Object[][] lseHybridData) {
        ...
        for(int i=0; i<iRow; i++) {
            ...
            lseFixedDemandList.add(FixedDemandArray);
        }
        ...
        if(lsePriceSensitiveData!=null) {
            ...
            for(int i=0; i<iRow; i++) {
                ...
                lsePriceSensitiveDemandList.add(PriceDemandArray);
            }
        }
        ...
        if(lseHybridData!=null) {
            ...
            for(int i=0; i<iRow; i++) {
                ...
                lseHybridDemandList.add(HybridDemandArray);
    ...
    public void saveTableDataToList() {
        ...
        for(int i=0; i<lseHybridDemandList.size(); i++) {
            ...
            if(selectedName.equalsIgnoreCase(temp[0].toString())) {
                ...
                for (int j=0; j<lseFixedDemandList.size(); j++) {
                    Object [] tempFixed=(Object [])lseFixedDemandList.get(j);
    ...
    public void saveData() {
        ...
        mainFrame.lseData=TransListToArray(lseFixedDemandList);
    ...
    private void LSENameComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LSENameComboBoxActionPerformed
        ...
        if(iSelectedIndex<0) {
            ...
            temp[0]=selectedName;
            Object [] tempFixed=(Object [])lseFixedDemandList.get(iCurrentLSEFixedDemandIndex);
    ...
    public String DataVerify() {
        ...
        for(int i=0; i<lseHybridDemandList.size(); i++) {
            ...
            for (int k=0; k<lseFixedDemandList.size(); k++) {
                tempFixed=(Object [])lseFixedDemandList.get(k);
